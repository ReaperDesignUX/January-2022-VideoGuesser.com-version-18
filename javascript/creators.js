...
const videos = [
	...
	showvideo37,showvideo38,showvideo39,showvideo41,showvideo42,showvideo43,showvideo44,showvideo50,
	showvideo51,showvideo52,showvideo53,showvideo54,showvideo55,showvideo56,showvideo103,showvideo104,
	showvideo105,showvideo106,showvideo107,showvideo108,showvideo109,showvideo110,showvideo111,showvideo112,
	showvideo113,showvideo114,showvideo115,
];
/*golden videos*/
...
playNextVideo(); //starts the chain
...
function showvideo38() {
	document.querySelectorAll('video').forEach((video) => (video.style.display = "none")) //hide videos
	document.getElementById("video38").style.display = "block";
	document.getElementById('credit').innerHTML=video38_obj.credit; /*******credit******/
	document.getElementById('subtitles').innerHTML=video38_obj.subtitles; /*****subtitles*****/
	document.getElementById('buttonA').innerHTML = "⠀"; buttonA.onclick=null;
	document.getElementById('buttonB').innerHTML = "⠀"; buttonB.onclick=null;
	document.getElementById('buttonC').innerHTML = "⠀"; buttonC.onclick=null;
	document.getElementById('buttonD').innerHTML = "⠀"; buttonD.onclick=null;
...
let pause_video38 = function(){
	if (video38.currentTime >= 2.75) {
		//playTimerSong();
		//30s timer
		function sleep(ms) {
			return new Promise(resolve => setTimeout(resolve, ms));
...
*/
		video38.pause();
		video38.removeEventListener("timeupdate",pause_video38);
		document.getElementById("video38").style.pointerEvents = "none";
	
		document.getElementById("buttonA").innerHTML=video38_obj.A;
		document.getElementById("buttonA").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0;
		...
		document.getElementById("buttonB").innerHTML=video38_obj.B;
		document.getElementById("buttonB").onclick = function() {
		score++;
		if (score > high_score) high_score = score;
		if (buttonA.onclick = false) this.onclick = null; 
		...
		document.getElementById("buttonC").innerHTML=video38_obj.C;
		document.getElementById("buttonC").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
		...
		document.getElementById("buttonD").innerHTML=video38_obj.D;
		document.getElementById("buttonD").onclick=function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
...
video38.addEventListener("timeupdate", pause_video38);

/*****play next video*****/
document.getElementById('video38').addEventListener('ended',playNextVideo,false);
...
function showvideo50() {
	document.querySelectorAll('video').forEach((video) => (video.style.display = "none")) //hide videos
	document.getElementById("video50").style.display = "block";
	document.getElementById("video50").volume=0.5;
	document.getElementById('credit').innerHTML=video50_obj.credit; /*******credit******/
	document.getElementById('subtitles').innerHTML=video50_obj.subtitles; /*****subtitles*****/
	document.getElementById('buttonA').innerHTML = "⠀"; buttonA.onclick=null;
	document.getElementById('buttonB').innerHTML = "⠀"; buttonB.onclick=null;
	document.getElementById('buttonC').innerHTML = "⠀"; buttonC.onclick=null;
	document.getElementById('buttonD').innerHTML = "⠀"; buttonD.onclick=null;
...
let pause_video50 = function(){
	if (video50.currentTime >= 4) {
		//playTimerSong();
		//30s timer
		function sleep(ms) {
			return new Promise(resolve => setTimeout(resolve, ms));
...
*/
		video50.pause();
		video50.removeEventListener("timeupdate",pause_video50);
		document.getElementById("video50").style.pointerEvents = "none";
	
		document.getElementById("buttonA").innerHTML=video50_obj.A;
		document.getElementById("buttonA").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0;
		...
		document.getElementById("buttonB").innerHTML=video50_obj.B;
		document.getElementById("buttonB").onclick = function() {
		score++;
		if (score > high_score) high_score = score;
		if (buttonA.onclick = false) this.onclick = null; 
		...
		document.getElementById("buttonC").innerHTML=video50_obj.C;
		document.getElementById("buttonC").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
		...
		document.getElementById("buttonD").innerHTML=video50_obj.D;
		document.getElementById("buttonD").onclick=function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
...
video50.addEventListener("timeupdate", pause_video50);

/*****play next video*****/
document.getElementById('video50').addEventListener('ended',playNextVideo,false);



function showvideo51() {
	document.querySelectorAll('video').forEach((video) => (video.style.display = "none")) //hide videos
	document.getElementById("video51").style.display = "block";
	document.getElementById("video51").volume=0.5;
	document.getElementById('credit').innerHTML=video51_obj.credit; /*******credit******/
	document.getElementById('subtitles').innerHTML=video51_obj.subtitles; /*****subtitles*****/
	document.getElementById('buttonA').innerHTML = "⠀"; buttonA.onclick=null;
	document.getElementById('buttonB').innerHTML = "⠀"; buttonB.onclick=null;
	document.getElementById('buttonC').innerHTML = "⠀"; buttonC.onclick=null;
	document.getElementById('buttonD').innerHTML = "⠀"; buttonD.onclick=null;
...
let pause_video51 = function(){
	if (video51.currentTime >= 15) {
		//playTimerSong();
		//30s timer
		function sleep(ms) {
			return new Promise(resolve => setTimeout(resolve, ms));
...
*/
		video51.pause();
		video51.removeEventListener("timeupdate",pause_video51);
		document.getElementById("video51").style.pointerEvents = "none";
	
		document.getElementById("buttonA").innerHTML=video51_obj.A;
		document.getElementById("buttonA").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0;
		...
		document.getElementById("buttonB").innerHTML=video51_obj.B;
		document.getElementById("buttonB").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
		...
		document.getElementById("buttonC").innerHTML=video51_obj.C;
		document.getElementById("buttonC").onclick = function() {
		lives++; document.getElementById('lives').innerHTML="LIVES:<br>" + lives; //EMERALD VIDEO
		score++;
		if (score > high_score) high_score = score;
		...
		document.getElementById("buttonD").innerHTML=video51_obj.D;
		document.getElementById("buttonD").onclick=function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
...
video51.addEventListener("timeupdate", pause_video51);

/*****play next video*****/
document.getElementById('video51').addEventListener('ended',playNextVideo,false);



function showvideo52() {
	document.querySelectorAll('video').forEach((video) => (video.style.display = "none")) //hide videos
	document.getElementById("video52").style.display = "block";
	//document.getElementById("video52").onload=video52.play();
	document.getElementById("video52").volume=0.5;
	document.getElementById('credit').innerHTML=video52_obj.credit; /*******credit******/
	document.getElementById('subtitles').innerHTML=video52_obj.subtitles; /*****subtitles*****/
	document.getElementById('buttonA').innerHTML = "⠀"; buttonA.onclick=null;
	document.getElementById('buttonB').innerHTML = "⠀"; buttonB.onclick=null;
	document.getElementById('buttonC').innerHTML = "⠀"; buttonC.onclick=null;
	document.getElementById('buttonD').innerHTML = "⠀"; buttonD.onclick=null;
...
let pause_video52 = function(){
	if (video52.currentTime >= 3.5) {
		//playTimerSong();
		//30s timer
		function sleep(ms) {
			return new Promise(resolve => setTimeout(resolve, ms));
...
*/
		video52.pause();
		video52.removeEventListener("timeupdate",pause_video52);
		document.getElementById("video52").style.pointerEvents = "none";
	
		document.getElementById("buttonA").innerHTML=video52_obj.A;
		document.getElementById("buttonA").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0;
		...
		document.getElementById("buttonB").innerHTML=video52_obj.B;
		document.getElementById("buttonB").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
		...
		document.getElementById("buttonC").innerHTML=video52_obj.C;
		document.getElementById("buttonC").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
		...
		document.getElementById("buttonD").innerHTML=video52_obj.D;
		document.getElementById("buttonD").onclick=function() {
		score++; score++; //GOLDEN VIDEO
		if (score > high_score) high_score = score;
		if (buttonA.onclick = false) this.onclick = null; 
...
video52.addEventListener("timeupdate", pause_video52);

/*****play next video*****/
document.getElementById('video52').addEventListener('ended',playNextVideo,false);



function showvideo53() {
	document.querySelectorAll('video').forEach((video) => (video.style.display = "none")) //hide videos
	document.getElementById("video53").style.display = "block";
	document.getElementById('credit').innerHTML=video53_obj.credit; /*******credit******/
	document.getElementById('subtitles').innerHTML=video53_obj.subtitles; /*****subtitles*****/
	document.getElementById('buttonA').innerHTML = "⠀"; buttonA.onclick=null;
	document.getElementById('buttonB').innerHTML = "⠀"; buttonB.onclick=null;
	document.getElementById('buttonC').innerHTML = "⠀"; buttonC.onclick=null;
	document.getElementById('buttonD').innerHTML = "⠀"; buttonD.onclick=null;
...
let pause_video53 = function(){
	if (video53.currentTime >= 3) {
		//playTimerSong();
		//30s timer
		function sleep(ms) {
			return new Promise(resolve => setTimeout(resolve, ms));
...
*/
		video53.pause();
		video53.removeEventListener("timeupdate",pause_video53);
		document.getElementById("video53").style.pointerEvents = "none";
	
		document.getElementById("buttonA").innerHTML=video53_obj.A;
		document.getElementById("buttonA").onclick = function() {
			score++;
			if (score > high_score) high_score = score;
			if (buttonA.onclick = false) this.onclick = null; 
		...
		document.getElementById("buttonB").innerHTML=video53_obj.B;
		document.getElementById("buttonB").onclick = function() {
			lives--;
			if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
			if (lives < 0) lives = 0;
		...
		document.getElementById("buttonC").innerHTML=video53_obj.C;
		document.getElementById("buttonC").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
		...
		document.getElementById("buttonD").innerHTML=video53_obj.D;
		document.getElementById("buttonD").onclick=function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
...
video53.addEventListener("timeupdate", pause_video53);

/*****play next video*****/
document.getElementById('video53').addEventListener('ended',playNextVideo,false);



function showvideo54() {
	document.querySelectorAll('video').forEach((video) => (video.style.display = "none")) //hide videos
	document.getElementById("video54").style.display = "block";
	document.getElementById('credit').innerHTML=video54_obj.credit; /*******credit******/
	document.getElementById('subtitles').innerHTML=video54_obj.subtitles; /*****subtitles*****/
	document.getElementById('buttonA').innerHTML = "⠀"; buttonA.onclick=null;
	document.getElementById('buttonB').innerHTML = "⠀"; buttonB.onclick=null;
	document.getElementById('buttonC').innerHTML = "⠀"; buttonC.onclick=null;
	document.getElementById('buttonD').innerHTML = "⠀"; buttonD.onclick=null;
...
let pause_video54 = function(){
	if (video54.currentTime >= 5) {
		//playTimerSong();
		//30s timer
		function sleep(ms) {
			return new Promise(resolve => setTimeout(resolve, ms));
...
*/
		video54.pause();
		video54.removeEventListener("timeupdate",pause_video54);
		document.getElementById("video54").style.pointerEvents = "none";
	
		document.getElementById("buttonA").innerHTML=video54_obj.A;
		document.getElementById("buttonA").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0;
		...
		document.getElementById("buttonB").innerHTML=video54_obj.B;
		document.getElementById("buttonB").onclick = function() {
		score++;
		if (score > high_score) high_score = score;
		if (buttonA.onclick = false) this.onclick = null; 
		...
		document.getElementById("buttonC").innerHTML=video54_obj.C;
		document.getElementById("buttonC").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
		...
		document.getElementById("buttonD").innerHTML=video54_obj.D;
		document.getElementById("buttonD").onclick=function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
...
video54.addEventListener("timeupdate", pause_video54);

/*****play next video*****/
document.getElementById('video54').addEventListener('ended',playNextVideo,false);



function showvideo55() {
	document.querySelectorAll('video').forEach((video) => (video.style.display = "none")) //hide videos
	document.getElementById("video55").style.display = "block";
	document.getElementById('credit').innerHTML=video55_obj.credit; /*******credit******/
	document.getElementById('subtitles').innerHTML=video55_obj.subtitles; /*****subtitles*****/
	document.getElementById('buttonA').innerHTML = "⠀"; buttonA.onclick=null;
	document.getElementById('buttonB').innerHTML = "⠀"; buttonB.onclick=null;
	document.getElementById('buttonC').innerHTML = "⠀"; buttonC.onclick=null;
	document.getElementById('buttonD').innerHTML = "⠀"; buttonD.onclick=null;
...
let pause_video55 = function(){
	if (video55.currentTime >= 5) {
		//playTimerSong();
		//30s timer
		function sleep(ms) {
			return new Promise(resolve => setTimeout(resolve, ms));
...
*/
		video55.pause();
		video55.removeEventListener("timeupdate",pause_video55);
		document.getElementById("video55").style.pointerEvents = "none";
	
		document.getElementById("buttonA").innerHTML=video55_obj.A;
		document.getElementById("buttonA").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0;
		...
		document.getElementById("buttonB").innerHTML=video55_obj.B;
		document.getElementById("buttonB").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
		...
		document.getElementById("buttonC").innerHTML=video55_obj.C;
		document.getElementById("buttonC").onclick = function() {
		score++; score++; //GOLDEN VIDEO
		if (score > high_score) high_score = score;
		if (buttonA.onclick = false) this.onclick = null; 
		...
		document.getElementById("buttonD").innerHTML=video55_obj.D;
		document.getElementById("buttonD").onclick=function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
...
video55.addEventListener("timeupdate", pause_video55);

/*****play next video*****/
document.getElementById('video55').addEventListener('ended',playNextVideo,false);



function showvideo56() {
	document.querySelectorAll('video').forEach((video) => (video.style.display = "none")) //hide videos
	document.getElementById("video56").style.display = "block";
	document.getElementById("video56").volume=0.25;
	document.getElementById('credit').innerHTML=video56_obj.credit; /*******credit******/
	document.getElementById('subtitles').innerHTML=video56_obj.subtitles; /*****subtitles*****/
	document.getElementById('buttonA').innerHTML = "⠀"; buttonA.onclick=null;
	document.getElementById('buttonB').innerHTML = "⠀"; buttonB.onclick=null;
	document.getElementById('buttonC').innerHTML = "⠀"; buttonC.onclick=null;
	document.getElementById('buttonD').innerHTML = "⠀"; buttonD.onclick=null;
...
let pause_video56 = function(){
	if (video56.currentTime >= 11) {
		//playTimerSong();
		//30s timer
		function sleep(ms) {
			return new Promise(resolve => setTimeout(resolve, ms));
...
*/
		video56.pause();
		video56.removeEventListener("timeupdate",pause_video56);
		document.getElementById("video56").style.pointerEvents = "none";
	
		document.getElementById("buttonA").innerHTML=video56_obj.A;
		document.getElementById("buttonA").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0;
		...
		document.getElementById("buttonB").innerHTML=video56_obj.B;
		document.getElementById("buttonB").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
		...
		document.getElementById("buttonC").innerHTML=video56_obj.C;
		document.getElementById("buttonC").onclick = function() {
		lives--;
		if (lives === 1 || lives === 0) document.getElementById('lives').style.backgroundColor='darkred';	
		if (lives < 0) lives = 0; 
		...
		document.getElementById("buttonD").innerHTML=video56_obj.D;
		document.getElementById("buttonD").onclick=function() {
		score++;
		if (score > high_score) high_score = score;
		if (buttonA.onclick = false) this.onclick = null; 
...
video56.addEventListener("timeupdate", pause_video56);

/*****play next video*****/
document.getElementById('video56').addEventListener('ended',playNextVideo,false);
