...
//version
document.getElementById('version').innerHTML="Pre-Alpha v1.6.7";
...
let video4_credit = "<strong style='z-index:999;'>Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer)</strong> - https://linktr.ee/ChrisLuhrsVA </style>."; video4_credit = urlify(video4_credit);
const video4_obj = {
...
let video6_credit = "Credit: iScaper1 - https://bit.ly/3ezQrVK . | Editor: <strong style='color:red;'>ChrisLuhrsVA (Developer)</strong> - https://linktr.ee/ChrisLuhrsVA . | Voice: xQc - https://twitch.tv/xQcOW ."; video6_credit = urlify(video6_credit);
...
let video7_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer) (2014)</strong> - https://linktr.ee/ChrisLuhrsVA . | Music: Kevin Macleod (Attribution 3.0 License)."; video7_credit = urlify(video7_credit);
const video7_obj = {
...
let video8_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer) (2014)</strong> - https://linktr.ee/ChrisLuhrsVA ."; video8_credit = urlify(video8_credit);
const video8_obj = {
...
let video9_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer) (2014)</strong> - https://linktr.ee/ChrisLuhrsVA . | Voice: Dad."; video9_credit = urlify(video9_credit);
const video9_obj = {
...
let video10_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer) (2014)</strong> - https://linktr.ee/ChrisLuhrsVA ."; video10_credit = urlify(video10_credit);
const video10_obj = {
...
let video11_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer) (2014)</strong> - https://linktr.ee/ChrisLuhrsVA ."; video11_credit = urlify(video11_credit);
const video11_obj = {
...
let video12_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer) (2014)</strong> - https://linktr.ee/ChrisLuhrsVA ."; video12_credit = urlify(video12_credit);
const video12_obj = {
...
let video13_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer) (2014)</strong> - https://linktr.ee/ChrisLuhrsVA ."; video13_credit = urlify(video13_credit);
const video13_obj = {
...
let video14_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer)</strong> - https://linktr.ee/ChrisLuhrsVA ."; video14_credit = urlify(video14_credit);
const video14_obj = {
...
let video15_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer)</strong> - https://linktr.ee/ChrisLuhrsVA ."; video15_credit = urlify(video15_credit);
const video15_obj = {
...
let video19_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer) (2014)</strong> - https://linktr.ee/ChrisLuhrsVA ."; video19_credit = urlify(video19_credit);
const video19_obj = {
...
let video24_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer)</strong> - https://linktr.ee/ChrisLuhrsVA . | Music: Max Surla - Run. & MK2 - Hero Theme."; video24_credit = urlify(video24_credit);
const video24_obj = {
...
let video25_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer)</strong> - https://linktr.ee/ChrisLuhrsVA ."; video25_credit = urlify(video25_credit);
const video25_obj = {
...
let video38_credit = "Credit: Sliker - https://twitch.tv/itssliker ."; video38_credit = urlify(video38_credit);
function urlify(video38_credit) {
    var urlRegex = /(((https?:\/\/)|(www\.))[^\s]+)/g;
    return video38_credit.replace(urlRegex, function(url,b,c) {
        var url2 = (c == 'www.') ?  'http://' + url : url;
        return '<a href="' + url2 + '" target="_blank">' + url + '</a>';
    }) 
}
const video38_obj = {
    credit: video38_credit,
    subtitles: " Sliker is playing Minecraft.",
    A: "A) A skeleton shoots an arrow at him and he falls into the lava.",
    B: "B) He presses Q.",
    C: "C) He doesn't fall for it.",
    D: "D) A creeper explodes behind him and he falls into the lava.",
};
...
let video45_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer)</strong> - https://linktr.ee/ChrisLuhrsVA ."; video45_credit = urlify(video45_credit);
const video45_obj = {
...
let video46_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer)</strong> - https://linktr.ee/ChrisLuhrsVA ."; video46_credit = urlify(video46_credit);
const video46_obj = {
...
let video47_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer)</strong> - https://linktr.ee/ChrisLuhrsVA ."; video47_credit = urlify(video47_credit);
const video47_obj = {
...
let video48_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer)</strong> - https://linktr.ee/ChrisLuhrsVA ."; video48_credit = urlify(video48_credit);
const video48_obj = {
...
let video49_credit = "Credit: <strong style='color:red;'>ChrisLuhrsVA (Developer)</strong> - https://linktr.ee/ChrisLuhrsVA ."; video49_credit = urlify(video49_credit);
const video49_obj = {
...
let video50_credit = "Credit: Sliker - https://twitch.tv/itssliker ."; video50_credit = urlify(video50_credit);
function urlify(video50_credit) {
    var urlRegex = /(((https?:\/\/)|(www\.))[^\s]+)/g;
    return video50_credit.replace(urlRegex, function(url,b,c) {
        var url2 = (c == 'www.') ?  'http://' + url : url;
        return '<a href="' + url2 + '" target="_blank">' + url + '</a>';
    }) 
}
const video50_obj = {
    credit: video50_credit,
    subtitles: "Sliker is playing Phasmophobia.",
    A: "A) He pees his pants.",
    B: "B) He gets jumpscared and throws his VR headset.",
    C: "C) He meets a friendly ghost.",
    D: "D) He uninstalls the game.",
};

let video51_credit = "Credit: Sliker - https://twitch.tv/itssliker ."; video51_credit = urlify(video51_credit);
function urlify(video51_credit) {
    var urlRegex = /(((https?:\/\/)|(www\.))[^\s]+)/g;
    return video51_credit.replace(urlRegex, function(url,b,c) {
        var url2 = (c == 'www.') ?  'http://' + url : url;
        return '<a href="' + url2 + '" target="_blank">' + url + '</a>';
    }) 
}
const video51_obj = {
    credit: video51_credit,
    subtitles: "Sliker is playing a horror game. What will happen to the monster?",
    A: "A) It kills him.",
    B: "B) It explodes.",
    C: "C) It trips and falls.",
    D: "D) It turns into slime.",
};

let video52_credit = "Credit: Sliker - https://twitch.tv/itssliker ."; video52_credit = urlify(video52_credit);
function urlify(video52_credit) {
    var urlRegex = /(((https?:\/\/)|(www\.))[^\s]+)/g;
    return video52_credit.replace(urlRegex, function(url,b,c) {
        var url2 = (c == 'www.') ?  'http://' + url : url;
        return '<a href="' + url2 + '" target="_blank">' + url + '</a>';
    }) 
}
const video52_obj = {
    credit: video52_credit,
    subtitles: "Sliker is playing CS:GO.",
    A: "A) He wins.",
    B: "B) He kills his friend.",
    C: "C) His game crashes.",
    D: "D) He activates his cheats and still dies.",
};

let video53_credit = "Credit: Sliker - https://twitch.tv/itssliker ."; video53_credit = urlify(video53_credit);
function urlify(video53_credit) {
    var urlRegex = /(((https?:\/\/)|(www\.))[^\s]+)/g;
    return video53_credit.replace(urlRegex, function(url,b,c) {
        var url2 = (c == 'www.') ?  'http://' + url : url;
        return '<a href="' + url2 + '" target="_blank">' + url + '</a>';
    }) 
}
const video53_obj = {
    credit: video53_credit,
    subtitles: "What will the lever do?",
    A: "A) Shoot water out of a tiny boat.",
    B: "B) Nothing.",
    C: "C) It's broken.",
    D: "D) Activates a trap door.",
};

let video54_credit = "Credit: Sliker - https://twitch.tv/itssliker ."; video54_credit = urlify(video54_credit);
function urlify(video54_credit) {
    var urlRegex = /(((https?:\/\/)|(www\.))[^\s]+)/g;
    return video54_credit.replace(urlRegex, function(url,b,c) {
        var url2 = (c == 'www.') ?  'http://' + url : url;
        return '<a href="' + url2 + '" target="_blank">' + url + '</a>';
    }) 
}
const video54_obj = {
    credit: video54_credit,
    subtitles: "How many motorcycles will Sliker see?",
    A: "A) Maybe 7.",
    B: "B) 6 and the FBI.",
    C: "C) Only 2.",
    D: "D) Probably 10.",
...
let video55_credit = "Credit: Sliker - https://twitch.tv/itssliker . | Music: https://bit.ly/3BfPyKp ."; video55_credit = urlify(video55_credit);
function urlify(video55_credit) {
    var urlRegex = /(((https?:\/\/)|(www\.))[^\s]+)/g;
    return video55_credit.replace(urlRegex, function(url,b,c) {
        var url2 = (c == 'www.') ?  'http://' + url : url;
        return '<a href="' + url2 + '" target="_blank">' + url + '</a>';
    }) 
}
const video55_obj = {
    credit: video55_credit,
    subtitles: "Sliker is playing CS:GO. What will he do?",
    A: "A) Game will crash.",
    B: "B) Get mic spammed by teammates flaming him.",
    C: "C) Team wipe.",
    D: "D) Lose the 1v4.",
};

let video56_credit = "Credit: Sliker - https://twitch.tv/itssliker ."; video56_credit = urlify(video56_credit);
function urlify(video56_credit) {
    var urlRegex = /(((https?:\/\/)|(www\.))[^\s]+)/g;
    return video56_credit.replace(urlRegex, function(url,b,c) {
        var url2 = (c == 'www.') ?  'http://' + url : url;
        return '<a href="' + url2 + '" target="_blank">' + url + '</a>';
    }) 
}
const video56_obj = {
    credit: video56_credit,
    subtitles: "Did Sliker get partnered in this clip?",
    A: "A) Yes.",
    B: "B) Maybe.",
    C: "C) His mom walks in.",
    D: "D) Jebaited.",
};
...
const video84_obj = {
    ...
    D: "D) The bird bites her fingernail and bounces up and down with its wings spread.",
};
...
const video89_obj = {
    ...
    subtitles: "How many balls will he sink?",
    A: "A) 4.",
    B: "B) 5.",
    C: "C) Half of them.",
    D: "D) All of them.",
...
const video104_obj = {
    ...
    subtitles: "Will he sink the ball?",
    A: "A) Possibly.",
    B: "B) Maybe.",
    C: "C) No.",
    D: "D) Yes.",
